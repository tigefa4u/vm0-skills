...
1. **Nature of the shift**: Describe precisely what is changing
2. **Driving forces**: What enables or compels this change? (technological capability, regulation, economic pressure, behavioral evolution)
3. **Affected segments**: Which customer populations or market categories feel the impact?
4. **Time horizon**: Is this unfolding now, within one to two years, or over a three-to-five year arc?
5. **Strategic implications**: How should this influence product direction, investment, or positioning?
6. **Competitive response**: How are rivals reacting to this trend?
